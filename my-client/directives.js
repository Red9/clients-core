    ...
    angular.module('redApp.directives', [])
        .directive('resourceList', function () {
            return {
                ...
                templateUrl: function (element, attributes) {
                    return '/my-client/partials/directives/' + attributes.resourceType + 'list.html';
                },
                scope: {
                    resourceFilters: '=',
                    resourceType: '@'
        ...
        .directive('eventSearch', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/eventsearch.html',
        ...
        .directive('datasetSearch', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/datasetsearch.html',
        ...
        .directive('userInput', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/userinput.html',
        ...
        .directive('badgeList', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/badgelist.html',
        ...
        .directive('tagHelper', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/taghelper.html',
        ...
        .directive('compoundStatistics', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/compoundstatistics.html',
                controller: function ($scope) {
        ...
        .directive('temporalStatistics', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/temporalstatistics.html',
                controller: function ($scope) {
                    $scope.listUrl = '/' + $scope.resourceType + '/?idList=' + $scope.idList.join(',');
                }
            };
        ...
        .directive('summaryStatistics', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/summarystatistics.html',
                controller: function ($scope) {
                }
            };
        })
        .directive('listGroupSimple', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/listgroupsimple.html',
                controller: function ($scope) {
                    $scope.newItem = '';
        ...
        .directive('map', function () {
            return {
                ...
                templateUrl: '/my-client/partials/directives/map.html',
                controller: function ($scope, _) {
                    $scope.map = {
                        markers: {},
                        paths: {},
        ...
        .directive('userDetails', function () {
            return {
                restrict: 'E',
                templateUrl: '/my-client/partials/directives/userdetails.html',
                controller: function ($scope, _) {
        ...
        .directive('aggregateStatistics', function () {
            return {
                restrict: 'E',
                templateUrl: '/my-client/partials/directives/aggregatestatistics.html',
                controller: function ($scope, _) {
        ...
        .directive('eventsSummary', function () {
            return {
                restrict: 'E',
                templateUrl: '/my-client/partials/directives/eventssummary.html',
                scope: {
                    events: '='
                },
                controller: function ($scope, _) {
        ...
        .directive('fcpxmlDownload', function () {
            return {
                restrict: 'E',
                templateUrl: '/my-client/partials/directives/fcpxmldownload.html',
                scope: {
                    dataset: '='
                },
                controller: function ($scope) {
        ...
        function () {
            return {
                restrict: 'E',
                templateUrl: function (element, attributes) {
                    return '/my-client/partials/directives/eventsummary/' + attributes.type;
                },
                scope: {
                    event: '=',
                    type: '@'
